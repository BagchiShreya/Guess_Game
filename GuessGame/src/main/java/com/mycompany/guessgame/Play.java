...
public class Play extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        guessTxt.setForeground(new java.awt.Color(204, 0, 204));
        ...
        chanceLbl.setForeground(new java.awt.Color(255, 255, 255));
        chanceLbl.setText("5");
        ...
        resLbl.setForeground(new java.awt.Color(255, 255, 255));
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        if(guessTxt.getText().isEmpty() || Integer.parseInt(guessTxt.getText())<1 || Integer.parseInt(guessTxt.getText())>100){
            ...
            if(Integer.parseInt(guessTxt.getText()) == random){
                resLbl.setText("Yess! Your guess was correct.");
                scoreLbl.setText(""+(Integer.parseInt(scoreLbl.getText())+100));
            }
            else{
                resLbl.setText("Oh no! Your guess was wrong. Correct Number was "+random+".");
